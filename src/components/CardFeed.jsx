...
function CardFeed() {
  return (
    <div className="rounded-md bg-gray-500 space-y-2">
      ...
      {/* <img className="h-50" src="https://www.pangoo.biz/wp-content/uploads/2024/04/Feed-Ingredients-1-1.jpeg" alt="" /> */}
      <div className="p-4">
        ...
        {/* <h3 className="pt-4 text-md">Projeto para curso de HTML e CSS</h3> */}
